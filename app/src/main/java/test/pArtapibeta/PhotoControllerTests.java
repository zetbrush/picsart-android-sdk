...
public class PhotoControllerTests  {
    ...
    @Test(expected=AssertionFailedError.class)
    public static  void testAddComment(String phid,String comment, String token){
    ...
    @Test(expected=AssertionFailedError.class)
    public static  void testDeleteComment(String phId,String commentId, String token){
        final PhotoController pc = new PhotoController(MainActivity.getAppContext(), token);
        pc.setListener(new RequestListener(1) {
            @Override
            public void onRequestReady(int requmber,String mmsg) {
    ...
    @Test(expected=AssertionFailedError.class)
    public static  void testRequestComments(String phId,int offset, int limit, String token){
        final PhotoController pc = new PhotoController(MainActivity.getAppContext(), token);
        pc.setListener(new RequestListener(1) {
            @Override
            public void onRequestReady(int requmber,String mmsg) {
    ...
    @Test(expected=AssertionFailedError.class)
    public static  void testGetLikedUsers(String phId, int offset,int limit, String token){
        final PhotoController pc = new PhotoController(MainActivity.getAppContext(), token);
        pc.setListener(new RequestListener(1) {
            @Override
            public void onRequestReady(int requmber,String mmsg) {
