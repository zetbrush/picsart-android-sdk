 ...
 * by calling {@link org.apache.http.client.methods.CloseableHttpResponse#close()} methods in case of an I/O, protocol or
...
public interface ClientExecChain {
     ...
     * @throws java.io.IOException in case of a I/O error.
     *   (this type of exceptions are potentially recoverable).
     * @throws org.apache.http.HttpException in case of an HTTP protocol error
