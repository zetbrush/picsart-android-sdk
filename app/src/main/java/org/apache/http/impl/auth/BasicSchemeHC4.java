...
public class BasicSchemeHC4 extends RFC2617SchemeHC4 {
     ...
     *
     * @throws org.apache.http.auth.MalformedChallengeException is thrown if the authentication challenge
     * is malformed
     */
    @Override
     ...
     *   org.apache.http.auth.Credentials, org.apache.http.HttpRequest, org.apache.http.protocol.HttpContext)}
     */
    @Deprecated
    ...
    /**
     * Produces basic authorization header for the given set of {@link org.apache.http.auth.Credentials}.
     *
     ...
     * @throws org.apache.http.auth.AuthenticationException if authorization string cannot
     ...
     * {@link org.apache.http.auth.Credentials} and charset.
     *
     ...
     *
     * @deprecated (4.3) use {@link #authenticate(org.apache.http.auth.Credentials, org.apache.http.HttpRequest, org.apache.http.protocol.HttpContext)}.
     */
    @Deprecated
