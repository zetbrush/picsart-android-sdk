...
/**
 * Default implementation of {@link org.apache.http.cookie.SetCookie}.
 *
 * @since 4.0
 */
@NotThreadSafe
public class BasicClientCookieHC4 implements SetCookie, ClientCookie, Cloneable, Serializable {
     ...
     *
     * @param expiryDate the {@link java.util.Date} after which this cookie is no longer valid.
     *
     * @see #getExpiryDate
     *
     */
   ...
   // ----------------------------------------------------- Instance Variables
    ...
    /** Expiration {@link java.util.Date}. */
