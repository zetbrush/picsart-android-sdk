 ...
 * Internally this executor relies on a {@link org.apache.http.protocol.HttpProcessor} to populate
 * requisite HTTP request headers, process HTTP response headers and update
 * session state in {@link org.apache.http.client.protocol.HttpClientContext}.
 * <p/>
