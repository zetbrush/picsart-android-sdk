...
public abstract class AbstractMessageWriterHC4<T extends HttpMessage> implements HttpMessageWriter {
     ...
     *
     * @deprecated (4.3) use
     *   {@link org.apache.http.impl.io.AbstractMessageWriterHC4#AbstractMessageWriterHC4(org.apache.http.io.SessionOutputBuffer, org.apache.http.message.LineFormatter)}
     */
    @Deprecated
     ...
     *
     * @param buffer the session output buffer.
     * @param formatter the line formatter If <code>null</code> {@link org.apache.http.message.BasicLineFormatterHC4#INSTANCE}
     *   will be used.
     *
     * @since 4.3
     */
     ...
     * based on the {@link org.apache.http.HttpMessage} passed as a parameter.
     *
