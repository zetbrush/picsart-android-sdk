...
public class RequestContentHC4 implements HttpRequestInterceptor {
     ...
     * will cause the interceptor to throw {@link org.apache.http.ProtocolException} if already present in the
     * response message.
     */
     ...
     * {@link org.apache.http.ProtocolException} if already present in the response message.
     *
     * @since 4.2
     */
