...
public class BasicLineParserHC4 implements LineParser {
     ...
     * Note that {@link org.apache.http.message.BasicLineParser} is not a singleton, there can
     ...
     */
    @Deprecated
    public final static BasicLineParserHC4 DEFAULT = new BasicLineParserHC4();

    public final static BasicLineParserHC4 INSTANCE = new BasicLineParserHC4();
     ...
     */
    public BasicLineParserHC4(final ProtocolVersion proto) {
