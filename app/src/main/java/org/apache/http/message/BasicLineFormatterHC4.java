 ...
 * This is the complement to {@link org.apache.http.message.LineParser}.
...
public class BasicLineFormatterHC4 implements LineFormatter {
     ...
     * Note that {@link org.apache.http.message.BasicLineFormatter} is not a singleton, there can
     ...
     */
    @Deprecated
    public final static BasicLineFormatterHC4 DEFAULT = new BasicLineFormatterHC4();

    public final static BasicLineFormatterHC4 INSTANCE = new BasicLineFormatterHC4();
    ...
    public static
        ...
        return (formatter != null ? formatter : BasicLineFormatterHC4.INSTANCE)
