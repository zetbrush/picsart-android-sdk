...
public interface ConnectionSocketFactory {
     ...
     * {@link #connectSocket(int, java.net.Socket, org.apache.http.HttpHost, java.net.InetSocketAddress, java.net.InetSocketAddress,
     *    org.apache.http.protocol.HttpContext) connectSocket} method.
     *
     * @return  a new socket
     *
     ...
     * @param sock the socket to connect, as obtained from {@link #createSocket(org.apache.http.protocol.HttpContext)}.
