...
public class StringEntityHC4 extends AbstractHttpEntityHC4 implements Cloneable {
     ...
     *   MIME type {@link org.apache.http.entity.ContentType#TEXT_PLAIN} is assumed.
     *
     ...
     *   is {@link org.apache.http.protocol.HTTP#DEFAULT_CONTENT_CHARSET} i.e. "ISO-8859-1"
     * @throws  java.io.UnsupportedEncodingException If the named charset is not supported.
     *
     * @since 4.1
     * @throws IllegalArgumentException if the string parameter is null
     *
     * @deprecated (4.1.3) use {@link #StringEntityHC4(String, org.apache.http.entity.ContentType)}
     */
    @Deprecated
     ...
     * @param string content to be used. Not {@code null}.
     * @param charset character set to be used. May be {@code null}, in which case the default
     *   is {@link org.apache.http.protocol.HTTP#DEFAULT_CONTENT_CHARSET} is assumed
     *
     * @throws IllegalArgumentException if the string parameter is null
     * @throws java.nio.charset.UnsupportedCharsetException Thrown when the named charset is not available in
     * this instance of the Java virtual machine
     ...
     * {@link org.apache.http.entity.ContentType#TEXT_PLAIN}.
     *
     * @param string content to be used. Not {@code null}.
     *
     * @throws IllegalArgumentException if the string parameter is null
     * @throws java.io.UnsupportedEncodingException if the default HTTP charset is not supported.
     */
