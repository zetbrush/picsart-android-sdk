 ...
 * Therefore, one <b>must</b> call {@link java.util.concurrent.Future#get()} or {@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit)}
 * method on the {@link java.util.concurrent.Future} object returned by the
 * {@link #lease(Object, Object, org.apache.http.concurrent.FutureCallback)} method in order for the lease operation
 * to complete.
 *
...
public abstract class AbstractConnPool<T, C, E extends PoolEntry<T, C>>
     ...
     * {@link Thread}s. Therefore, one <b>must</b> call {@link java.util.concurrent.Future#get()}
     * or {@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit)} method on the {@link java.util.concurrent.Future}
