...
public class UrlEncodedFormEntityHC4 extends StringEntityHC4 {
    ...
    /**
     * Constructs a new {@link org.apache.http.client.entity.UrlEncodedFormEntity} with the list
     * of parameters in the specified encoding.
     *
     * @param parameters list of name/value pairs
     * @param charset encoding the name/value pairs be encoded with
     * @throws java.io.UnsupportedEncodingException if the encoding isn't supported
     */
