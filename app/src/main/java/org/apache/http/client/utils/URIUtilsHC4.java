...
/**
 * A collection of utilities for {@link java.net.URI URIs}, to workaround
...
public class URIUtilsHC4 {
     ...
     /**
         * Constructs a {@link java.net.URI} using all the parameters. This should be
         * used instead of
         ...
         *
         * @deprecated (4.2) use {@link org.apache.http.client.utils.URIBuilder}.
         */
    @Deprecated
     ...
     * {@link org.apache.http.client.utils.URIUtilsHC4#rewriteURI(java.net.URI, org.apache.http.HttpHost, boolean)} that always keeps the
     * fragment.
     */
    public static URI rewriteURI(
            final URI uri,
    ...
    /**
     * A convenience method that creates a new {@link java.net.URI} whose scheme, host, port, path,
     ...
     * fragment identifier, then combining the result into a {@link java.net.URI}.
     *
     * @param originalURI
