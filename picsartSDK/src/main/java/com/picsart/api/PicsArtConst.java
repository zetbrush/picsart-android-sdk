...
public class PicsArtConst {
    ...
    public static final String OAUTH_URL = "https://com.picsart.com/api/oauth2/authorize";
    public static final String TOKEN_URL = "https://com.picsart.com/api/oauth2/token";


    public static final String TOKEN_URL_PREFIX = ".json?token=";
    public static final String Get_PHOTO_URL = "http://com.picsart.com/api/photos/";
    public static final String TOKEN_PREFIX = "?token=";
    public static final String USER_URL_PATH = "http://com.picsart.com/api/users/";


    public static final String PHOTO_GENERAL_PREFIX = "http://com.picsart.com/api/photos/";
    public static final String OFFSET = "&offset=";
    public static final String LIMIT = "&limit=";
    public static final String GET_PHOTO_FILTER = "?filter=";


    public static final String PHOTO_UPLOAD_URL = "https://com.picsart.com/api/photos";
    public static final String PHOTO_COVER_ENDX = "/photos/cover";
    public static final String PHOTO_AVATAR_ENDX = "/photos/avatar";

    public static final String PHOTO_COMMENTS_URL = "https://api.com.picsart.com/photos/comments/show/";
    public static final String PHOTO_ADD_COMMENT_URL = "/comments";
    public static final String PHOTO_COMMENT_MIDLE = "/comments/";

    public static final String PHOTO_PRE_URL = "https://com.picsart.com/api/photos/";
    ...
    public static final String SHOW_USER = "https://com.picsart.com/api/users/";
